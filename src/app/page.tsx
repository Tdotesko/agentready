...
function StatusBadge({ status }: { status: "pass" | "warn" | "fail" }) {
  ...
  return (
    <span
      className={`px-2 py-0.5 text-xs font-bold rounded border ${styles[status]}`}
    >
      {labels[status]}
    </span>
  );
    ...
    <div className="flex flex-col items-center gap-6 py-16">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 mt-2">
          Analyzing structured data, product info, and agent accessibility
        </p>
      </div>
    </div>
  );
...
export default function Home() {
  ...
  function handleEmailSubmit(e: React.FormEvent) {
    ...
    // In production, send to your email service / database
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold">
              Agent<span className="text-indigo-400">Ready</span>
            </span>
          </div>
      ...
      <main className="flex-1">
        <section className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
          ...
          <h1 className="text-4xl sm:text-6xl font-bold tracking-tight leading-tight mb-6">
            Find out if AI agents
            <br />
            <span className="text-indigo-400">can buy from your store</span>
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-10">
            Google, Visa, and OpenAI are building AI shopping agents that buy
            products autonomously. Scan your store to see if agents can discover,
            understand, and purchase your products.
          </p>
          ...
          >
            ...
            <button
              ...
              className="px-8 py-4 rounded-xl bg-indigo-600 hover:bg-indigo-500 disabled:bg-gray-700 disabled:text-gray-500 font-semibold text-lg transition-colors cursor-pointer"
            >
          ...
          {error && (
            <div className="mt-6 max-w-2xl mx-auto p-4 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400">
              {error}
            </div>
          )}
        </section>
              ...
              {!emailSubmitted ? (
                <div className="mt-8 p-6 rounded-xl bg-indigo-600/10 border border-indigo-500/20">
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    Receive a detailed PDF with step-by-step fix instructions,
                    code snippets, and priority ranking — delivered to your
                    inbox.
                  </p>
                  <form
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="px-6 py-3 rounded-lg bg-indigo-600 hover:bg-indigo-500 font-semibold transition-colors cursor-pointer"
                    >
                      Send Report
                    </button>
                  </form>
          ...
          <>
                ...
                {[
                  {
                    ...
                    desc: "Paste your Shopify, WooCommerce, or any e-commerce store URL.",
                  },
                  {
                    step: "2",
                    title: "We scan for agent readiness",
                    desc: "Our scanner checks structured data, product markup, machine accessibility, and commerce signals.",
                  },
                  {
                    step: "3",
                    title: "Get your score & fixes",
                    desc: "See exactly what AI agents can and can't read, with specific recommendations to improve.",
                  },
                ].map((item) => (
                  <div
                    key={item.step}
            ...
            <section id="why" className="max-w-5xl mx-auto px-6 py-20">
              ...
              <p className="text-gray-400 text-center max-w-2xl mx-auto mb-12">
                The shift to AI-powered shopping is happening faster than anyone
                predicted.
              </p>
              <div className="grid sm:grid-cols-2 gap-6">
                {[
                  {
                    stat: "$1T+",
                    label: "SaaS market value shifted in the Feb 2026 SaaSpocalypse",
                  },
                  {
                    stat: "Millions",
                    label: "of consumers predicted to use AI agents to shop by holiday 2026 (Visa)",
                  },
                  {
                    stat: "41.5%",
                    label: "of YC Winter 2026 batch is building AI agent infrastructure",
                  },
                  {
                    stat: "UCP",
                    label: "Universal Commerce Protocol launched by Google with Shopify, Etsy, Target, Walmart",
                  },
                ].map((item) => (
                  <div
                    key={item.label}
